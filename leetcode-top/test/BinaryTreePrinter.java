import tree.Code0105_ConstructBinaryTreeFromPreorderAndInorderTraversal;
...
public class BinaryTreePrinter {
    ...
    public static void main(String[] args) {
        Code0105_ConstructBinaryTreeFromPreorderAndInorderTraversal tree =
                new Code0105_ConstructBinaryTreeFromPreorderAndInorderTraversal();
        int[] pre = {3, 9, 20, 15, 7};
        int[] in = {9, 3, 15, 20, 7};
